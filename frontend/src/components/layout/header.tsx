...
function getActionButton(pathname: string): ActionButton {
  ...
  if (pathname.startsWith("/members") || pathname.startsWith("/fulfillment-director") || pathname.startsWith("/coaching") || pathname.startsWith("/accountability") || pathname.startsWith("/tech-sos")) {
