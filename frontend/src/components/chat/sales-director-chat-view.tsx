...
const WELCOME_MESSAGE = `Hello! I'm your **Sales Director** — your AI-powered sales strategist for the Central Intelligence platform.

I have deep visibility into your sales pipeline: **Pipeline Health** (lead volume, conversion, funnel stages), **Lead Sources** (which channels convert best), and **Call Intelligence** (recurring objections, pain points, and buying triggers from your sales calls).

Ask me anything — here are a few ideas to get you started:

- "How's our pipeline looking this week?"
- "Which lead source converts best?"
- "What objections come up most on sales calls?"
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] text-gray-400 leading-none">
              {isConnected
                ? "Online — connected to sales data"
                : "Connecting…"}
            </span>
          </div>
        </div>
...
const DIRECTOR_SLUG = "sales-director";

export function SalesDirectorChatView() {
  const {
    messages,
    sendMessage,
    clearChat,
