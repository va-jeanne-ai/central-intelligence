...
const WELCOME_MESSAGE = `Hello! I'm your **Fulfillment Director** — your AI-powered client-success strategist for the Central Intelligence platform.

I have deep visibility into your fulfillment operations: **Member Health** (roster, statuses, enrollment trends), **Goal Progress** (where members stand on their goals), and **Coaching Intelligence** (wins, breakthroughs, and recurring blocks surfaced on coaching calls).

Ask me anything — here are a few ideas to get you started:

- "How are members progressing this week?"
- "What wins came up in coaching recently?"
- "Which members are stalling on their goals?"
- "What blocks come up most in coaching calls?"`;
  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 gap-3" role="status">
      <div className="relative">
        <div className="w-12 h-12 rounded-full border-3 border-gray-200 border-t-orange-500 animate-spin" />
        <span className="absolute inset-0 flex items-center justify-center text-lg">
          🏆
        </span>
      </div>
      <span className="text-sm text-gray-500 font-medium">
        Connecting to Fulfillment Director...
      </span>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] text-gray-400 leading-none">
              {isConnected
                ? "Online — connected to fulfillment data"
                : "Connecting…"}
            </span>
          </div>
        </div>
