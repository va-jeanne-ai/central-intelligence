  ...
  return (
    <span className="inline-flex items-center gap-1.5">
      <input
        ...
        className={`border border-orange-300 rounded px-1.5 py-0.5 focus:outline-none focus:ring-2 focus:ring-orange-300/50 ${inputClassName}`}
      />
      <button
        type="button"
        onClick={() => void commit()}
  ...
  return (
    <div className="space-y-2">
      <textarea
        ...
        className={`w-full border border-orange-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300/50 ${className}`}
      />
      <div className="flex items-center gap-2">
        <button
          ...
          onClick={() => void commit()}
          disabled={isSaving}
          className="text-[13px] font-medium px-3 py-1 rounded-lg bg-orange-500 hover:bg-orange-600 disabled:bg-orange-200 disabled:cursor-not-allowed text-white"
        >
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="text-[13px] font-medium text-orange-600 hover:text-orange-700 underline underline-offset-2"
            >
              Download transcript
            </button>
            <button
                ...
                {insights.map((ins) => (
                  <div key={ins.insight_id} className="px-5 py-3 group">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="text-[11px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded bg-orange-50 text-orange-700 border border-orange-200">
                        <InlineTextEdit
